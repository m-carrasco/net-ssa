...
// CHECK: IL_000b: s0 = 1
// CHECK: IL_000c: store l1, s0
// CHECK: IL_000d: br IL_001a
// CHECK: IL_0012: s0 = l0 [load]
// CHECK: IL_0013: s1 = l1 [load]
// CHECK: IL_0014: s0 = s0 * s1
// CHECK: IL_0015: store l0, s0
// CHECK: IL_0016: s0 = l1 [load]
// CHECK: IL_0017: s1 = 1
// CHECK: IL_0018: s0 = s0 + s1
// CHECK: IL_0019: store l1, s0
// CHECK: IL_001a: s0 = l1 [load]
// CHECK: IL_001b: s1 = a0 [load]
// CHECK: IL_001c: br IL_0012 if s0 <= s1
// CHECK: IL_0021: s0 = l0 [load]
